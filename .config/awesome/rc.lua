...
beautiful.init('~/.local/share/awesome/lib/beautiful.lua')
...
beautiful.init("~/.local/share/awesome/themes/default/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86AudioMute", function () awful.util.spawn("/home/mhristof/.mute-cmd.sh || amixer sset Master toggle;") end),
...
client.connect_signal("focus", function(c) c.border_color = "#66FF33" end)
